	...
	: QMainWindow(parent)
{
	...
	activate(TOOL::OBJ);
	activate(TOOL::BG);
	activate(TOOL::LOAD_TEX);

	inactivate(TOOL::TEX_U);
	inactivate(TOOL::TEX_WLS);
	inactivate(TOOL::TEX_SP);
	inactivate(TOOL::TEX_ARAP);
...
void MainWindow::Init(){
	char tn[TOOLNUM][128] = {"load_obj", "load_tex", "tex_U", "tex_WLS", "tex_SP", "tex_ARAP", "saveas", "background", 

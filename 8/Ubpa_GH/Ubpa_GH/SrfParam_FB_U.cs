...
namespace Ubpa_GH
{
    public class SrfParam_FB_U : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the SrfParam_FB_U class.
        /// </summary>
        public SrfParam_FB_U()
            : base("SrfParam_FB_U", "SrfParam_FB_U",
                "SrfParam_FB_U",
                "Ubpa_GH", "Lab5")
        {
        }
        ...
        {
            get { return new Guid("884c7358-d2ab-4d79-b4c4-957dbcbea6db"); }
        }
    }
}